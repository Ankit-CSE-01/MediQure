...
function fetchHospitals($lat, $lng) {
    ...
    $options = [
        'http' => [
            'header' => "User-Agent: MediQure Hospital Finder/1.0\r\n",
...
<head>
    ...
    <meta name="description" content="Find nearby hospitals with MediQure's hospital locator">
    <title>Nearby Hospitals - MediQure</title>
...
<header class="mb-6">
    <div class="flex justify-between items-start">
        ...
        <div class="flex items-center space-x-4">
            ...
            <button class="theme-toggle text-gray-700 hover:text-green-600 focus:outline-none">
