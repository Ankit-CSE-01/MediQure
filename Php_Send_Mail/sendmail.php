...
if(isset($_POST['submitContact'])) {
    ...
    try {
        ...
        $mail->Username = '73ankitkrsingh@gmail.com';  // SMTP username
        $mail->Password = 'ghie sbyq adxx zslc';           // SMTP password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS; // Enable TLS
        $mail->Port = 587;                         // TCP port (587 for TLS)

        // Recipients
        $mail->setFrom('73ankitkrsingh@gmail.com', 'Ankit');
        $mail->addAddress('medicure053@gmail.com', 'medi');
